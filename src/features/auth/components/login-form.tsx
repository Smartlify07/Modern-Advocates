...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-[45px]", className)} {...props}>
      ...
      <div className="flex w-full flex-wrap items-center justify-center gap-2.5 rounded-md bg-ma-surface-2 px-[30px] py-[50px] leading-normal">
        <FieldDescription className="text-center text-base/[100%] text-muted-foreground md:text-lg">
