...
export function ModuleEditor() {
  ...
  const addTopic = () => {
    const newTopic = { id: `topic_${Date.now()}`, title: "", type: "video_and_text" as const, videoUrl: null, videoId: null, videoTitle: null, description: null, order: module.topics.length }
