...
export function CtaSection() {
  return (
    <section className="xl:px-25 2xl:px-50">
      <section className="relative mx-auto my-20 flex min-h-[450px] w-full flex-col items-center justify-center overflow-hidden rounded-[24px] bg-ma-text px-6 text-center">
        <div className="mx-auto max-w-[650px]">
          <h2 className="mx-auto max-w-[600px] font-sans text-[40px]/[60px] font-extrabold tracking-[0%] text-white">
