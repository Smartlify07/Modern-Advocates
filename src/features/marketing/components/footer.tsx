  ...
  return (
    <footer className="overflow-hidden bg-white text-ma-text">
      <div className="relative mx-auto min-h-125 px-4 pt-12.5 lg:max-w-7xl lg:px-25 lg:pt-17.5 2xl:max-w-360 2xl:px-50">
        ...
        <p className="font-playfair pointer-events-none mt-10 bg-gradient-to-b from-ma-text from-[40%] to-ma-text/0 to-[74%] bg-clip-text text-center text-[40px] leading-none font-extrabold whitespace-nowrap text-transparent select-none md:text-[100px] lg:absolute lg:top-[72%] lg:left-1/2 lg:-translate-x-[calc(1280px/2-100px)] xl:text-[124px] 2xl:-translate-x-[calc(1280px/2-116px)]">
          ModernAdvocates
        </p>
      </div>
    </footer>
