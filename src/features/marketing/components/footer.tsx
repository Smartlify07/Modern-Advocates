  ...
  return (
    <footer className="overflow-hidden bg-white text-ma-text">
      <div className="relative mx-auto min-h-125 px-4 pt-12.5 lg:max-w-7xl lg:px-25 lg:pt-17.5 2xl:max-w-360">
        <div className="grid gap-10 md:grid-cols-[0.9fr_0.6fr_1.5fr] lg:gap-10 xl:grid-cols-[254px_180px_1fr] xl:justify-between xl:gap-50">
          <section className="">
          ...
          <section>
            <h2 className="border font-sans text-lg font-extrabold lg:text-2xl">
        ...
        <p className="pointer-events-none mt-10 max-w-[1100px] bg-gradient-to-b from-ma-text from-[40%] to-ma-text/0 to-[74%] bg-clip-text text-center font-playfair text-[40px] leading-none font-extrabold whitespace-nowrap text-transparent select-none md:text-[100px] lg:absolute lg:top-[72%] lg:left-1/2 lg:-translate-x-[calc(1280px/2-100px)] 2xl:-translate-x-[calc(1280px/2-116px)] 2xl:text-[124px]">
          ModernAdvocates
        </p>
      </div>
    </footer>
