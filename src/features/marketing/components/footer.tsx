...
export function Footer() {
  return (
    <footer className="overflow-hidden bg-white text-ma-text">
      <div className="marketing-container relative min-h-125 pt-12.5 lg:px-0! lg:pt-17.5">
        <div className="grid w-full gap-10 md:grid-cols-[0.9fr_0.6fr_1.5fr] lg:gap-10 xl:grid-cols-[254px_180px_1fr] xl:justify-between xl:gap-[140px] 2xl:gap-50">
          <section className="">
