    ...
    <section className="relative isolate overflow-hidden bg-[#fefafd] text-ma-text">
      <div className="absolute inset-0" aria-hidden="true">
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover object-center xl:object-[72%_center]"
          quality={100}
        />
      ...
      <div className="marketing-container relative z-10 flex min-h-[680px] max-w-360 items-center px-5 pt-14 pb-12 sm:px-8 lg:min-h-[924px]">
        <div className="text-center lg:max-w-[640px] lg:text-left 2xl:max-w-[709px]">
          <h1 className="marketing-header text-[38px]/[1.08] font-bold tracking-[-5%] text-balance text-ma-text sm:text-[52px]/[1.08] lg:text-[64px]/[1.08] xl:text-[70px]/[1.08]">
